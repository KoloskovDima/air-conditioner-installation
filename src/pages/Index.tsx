...
const services = [
  ...
  {
    icon: "Route",
    title: "Закладка трассы для кондиционера",
    desc: "Скрытая прокладка медной трассы, дренажа и электрики на этапе ремонта. Штробление стен, изоляция, опрессовка — всё готово к установке кондиционера в будущем.",
    time: "1 день",
    color: "#0099ff",
  },
  {
    icon: "Mountain",
    title: "Установка кондиционера альпинистами",
    desc: "Монтаж наружных блоков на высоте промышленными альпинистами без автовышки. Работаем на фасадах высоток, балконах и сложных объектах с соблюдением всех норм безопасности.",
    time: "1 день",
    color: "#00ccff",
  },
];
...
const guarantees = [
  {
    ...
    desc: "На все выполненные работы. При поломке по нашей вине — устраняем бесплатно.",
  },
  {
    icon: "Award",
    title: "Профессиональные монтажники",
    desc: "Обученные специалисты с большим опытом.",
  },
  {
    icon: "ClipboardCheck",
    title: "Официальный договор",
    desc: "Заключаем договор на каждый объект. Акт выполненных работ и гарантийный талон — после сдачи.",
  },
  {
    icon: "Clock",
    title: "Сроки по договору",
    desc: "Установка кондиционера — в удобное для вас время. Никаких переносов без предупреждения.",
  },
];
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pt-24">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-10 mt-16 pt-10 border-t" style={{ borderColor: "rgba(0,212,255,0.15)" }}>
              {[["5000+", "Объектов сдано"], ["5 лет", "На рынке"], ["24/7", "Поддержка"], ["2 года", "Гарантия"]].map(([num, label]) => (
                <div key={label}>
