...
const priceCategories = [
  ...
  },
  {
    ...
    icon: "Wrench",
    items: [
      { name: "Заправка фреоном R32/R410", price: "от 5 000 ₽" },
  ...
  },
  {
    ...
    icon: "Route",
    items: [
      { name: "Стандартная закладка трассы для кондиционера (7-12)", price: "от 10 000 ₽" },
      { name: "Стандартная закладка трассы (18)", price: "от 13 000 ₽" },
      { name: "Стандартная закладка трассы (24)", price: "от 16 000 ₽" },
    ],
  },
  {
    ...
    icon: "PlusCircle",
    items: [
      { name: "Прокладка трассы в единой связке после 5 метров (за 1 метр)", price: "от 1 800 ₽" },
      { name: "Прокладка короба Премиум 74х55 для трассы (за 1 метр)", price: "от 700 ₽" },
      { name: "Заглушка/уголок на декоративный короб Премиум, шт.", price: "от 350 ₽" },
      { name: "Опрессовка трассы азотом", price: "4 000 ₽" },
      { name: "Прокладка эл. кабеля до розетки", price: "от 500 ₽" },
      { name: "Прокладка короба для эл. кабеля (за 1 метр)", price: "200 ₽" },
      { name: "Прокладка дренажа в коробе, если идет отдельно от трассы (за 1 метр)", price: "200 ₽" },
      { name: "Демонтаж, монтаж фальш-потолка (за 1 кв.м)", price: "400 ₽" },
      { name: "Демонтаж внутреннего блока кондиционера", price: "от 2 500 ₽" },
      { name: "Демонтаж наружного блока кондиционера", price: "от 3 000 ₽" },
      { name: "Демонтаж + монтаж дренажной помпы", price: "3 500 ₽" },
      { name: "Монтаж дренажной помпы", price: "3 000 ₽" },
      { name: "Альпинистские работы", price: "от 10 000 ₽" },
      { name: "Снятие и установка оконного стеклопакета", price: "1 500 ₽" },
      { name: "Высотные работы (со страховочным поясом)", price: "от 3 000 ₽" },
      { name: "Установка наружного блока с лестницы (высота от 3 до 7 м.)", price: "от 3 000 ₽" },
      { name: "Пайка трассы", price: "от 1 000 ₽" },
      { name: "Установка дренажного сифона с установкой", price: "1 500 ₽" },
      { name: "Монтаж + демонтаж вент. фасада (1 кв.м)", price: "от 3 000 ₽" },
      { name: "Сверление дополнительного отверстия", price: "от 1 000 ₽" },
      { name: "Алмазное бурение отверстия", price: "от 2 000 ₽" },
      { name: "Вырез отверстия в вентилируемом фасаде", price: "1 000 ₽" },
      { name: "Спецкрепеж для наружного блока", price: "1 000 ₽" },
      { name: "Виброопоры с установкой", price: "1 700 ₽" },
      { name: "Вальцовка (подключение)", price: "1 000 ₽" },
      { name: "Штроба под дренаж (пеноблок/бетон) за погонный метр", price: "600/800 ₽" },
      { name: "Штроба под фреоновую трассу (пеноблок/кирпич) за погонный метр", price: "1 200/1 500 ₽" },
      { name: "Штроба под фреоновую трассу (бетон/монолит) за погонный метр", price: "2 000/2 500 ₽" },
    ],
  },
];
